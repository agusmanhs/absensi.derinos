...
class ReportController extends Controller
{
    ...
    public function pdfbulanan(Request $request)
{
    // SESUAIKAN dengan dropdown bulan dan tahun terpisah
    ...
    // Jika bulan yang dipilih adalah bulan sekarang dan belum tanggal 25
    if ($tahun == $today->year && $bulan == $today->month && $today->day < 25) {
        $tanggalMulai->subMonth();
    }
    ...
    return $pdf->stream('laporan-absensi-bulanan.pdf');
}
